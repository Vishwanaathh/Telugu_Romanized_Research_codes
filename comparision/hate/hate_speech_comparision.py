...
# =====================================================
# Create results folder (inside comparison/hate/)
# =====================================================
...
save_confusion_matrix("Logistic Regression", y_true, y_pred_lr)
save_confusion_matrix("Random Forest", y_true, y_pred_rf)
save_confusion_matrix("Tiny Transformer", y_true, y_pred_tf)
...
print("\n✅ All comparison results saved inside comparison/hate/results/")
